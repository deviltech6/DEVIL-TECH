...
async function connectToWA() {
  ...
  console.log("Connecting DEVIL-TECH-MD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("DEVIL-TECH-MD installed successful ✅");
      console.log("DEVIL-TECH-MD connected to whatsapp ✅");

      let up = `DEVIL-TECH-MD connected successful ✅`;
      let up1 = `Hello DEVIL-TECH-MD, I made bot successful`;
      ...
      robin.sendMessage("94760091093@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/deviltech6/Img/refs/heads/main/IMG-20250313-WA0220.jpg`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, DEVIL-TECH-MD started✅");
});
app.listen(port, () =>
